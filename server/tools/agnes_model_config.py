...
# ==================== 火山方舟 Seedance 视频模型 ====================
VOLCES_VIDEO_MODELS: List[str] = [
    "doubao-seedance-2-0-260128",
    "doubao-seedance-2-0-fast-260128",
]
"""火山方舟 Seedance 2.0 视频模型（generate_video_by_agnes 使用）"""

VOLCES_VIDEO_MODEL_DEFAULT: str = VOLCES_VIDEO_MODELS[0]

# ==================== Agnes 原生视频模型 ====================
AGNES_VIDEO_MODELS: List[str] = [
    "agnes-video-v2.0",
]
"""Agnes 原生视频 API 模型（仅 agnes_provider 使用）"""
...
def get_volces_video_models_with_fallback() -> tuple[str, List[str]]:
    if len(VOLCES_VIDEO_MODELS) == 0:
        raise ValueError("未配置任何火山方舟视频模型")
    return VOLCES_VIDEO_MODELS[0], VOLCES_VIDEO_MODELS[1:]


def is_valid_volces_video_model(model_name: str) -> bool:
    return model_name in VOLCES_VIDEO_MODELS
...
__all__ = [
    ...
    "VOLCES_VIDEO_MODELS",
    "VOLCES_VIDEO_MODEL_DEFAULT",
    "AGNES_VIDEO_MODELS",
    "AGNES_VIDEO_MODEL_DEFAULT",
    "get_volces_video_models_with_fallback",
